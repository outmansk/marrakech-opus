INSERT INTO properties_v2 (
  ...
  3,
  3,
  'Magnifique villa meublée avec piscine chauffée et jardin privé dans une résidence sécurisée.',
  ...
  ARRAY['Piscine', 'Jardin', 'Climatisation', 'Chauffage central', 'Cuisine équipée', 'Parking', 'Gardiennage 24/7', 'Internet Fibre', 'Terrasse', 'Cheminée'],
  ARRAY[
