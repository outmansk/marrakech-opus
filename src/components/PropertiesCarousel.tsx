...
const PropertiesCarousel = () => {
  ...
  return (
    <section className="bg-[#fbf8f2] pb-20 pt-8 md:pb-24 md:pt-8">
      <div className="mx-auto max-w-[1320px] px-5 md:px-10 xl:px-16">
        <Reveal>
          <div className="flex flex-col gap-5 border-b border-[#2b2722]/15 pb-7 md:flex-row md:items-end md:justify-between">
            <div>
              <p className="text-[10px] font-medium uppercase tracking-[0.26em] text-[#a4573e]">{tL("Sélection privée", "Private selection", "Selección privada")}</p>
              <h2 className="mt-3 text-[40px] leading-none tracking-[-0.025em] text-[#211f1b] md:text-[52px]">{tL("Propriétés à découvrir", "Properties to discover", "Propiedades por descubrir")}</h2>
            </div>
        ...
        {loading ? (
          ...
          <div className="-mx-5 mt-9 flex snap-x snap-mandatory gap-5 overflow-x-auto px-5 pb-4 scrollbar-hide md:mx-0 md:grid md:grid-cols-3 md:overflow-visible md:px-0 md:pb-0">
        ...
        <div className="mt-12 grid gap-px border-y border-[#2b2722]/15 bg-[#2b2722]/15 md:grid-cols-3">
          {[
